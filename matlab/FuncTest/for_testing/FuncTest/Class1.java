 ...
 * <pre>
 *  F:\\Cloud Storages\\Google Drive\\Desktop\\Test1\\FuncTest.m
 * </pre>
...
public class Class1 extends MWComponentInstance<Class1>
{
    ...
    /**
     * Maintains information used in calling the <code>FuncTest</code> MATLAB function.
     */
    private static final MWFunctionSignature sFuncTestSignature =
    ...
    {
        this(FuncTestMCRFactory.newInstance());
    }
    ...
    {
        this(FuncTestMCRFactory.newInstance(getPathToComponentOptions(pathToComponent)));
    }
    ...
    {
        this(FuncTestMCRFactory.newInstance(componentOptions));
    }
    ...
    {
        try {
            MWMCR mcr = FuncTestMCRFactory.newInstance();
            mcr.runMain( sFuncTestSignature, args);
            mcr.dispose();
        } catch (Throwable t) {
            t.printStackTrace();
        }
    ...
    /**
     * Provides the interface for calling the <code>FuncTest</code> MATLAB function 
     ...
     * </p>
     * <pre>
     * %FUNCTEST Summary of this function goes here
     ...
     * @throws MWException An error has occurred during the function call.
     */
    public void FuncTest(List lhs, List rhs) throws MWException
    {
        fMCR.invoke(lhs, rhs, sFuncTestSignature);
    }
     ...
     * @throws MWException An error has occurred during the function call.
     */
    public void FuncTest(Object[] lhs, Object[] rhs) throws MWException
    {
        fMCR.invoke(Arrays.asList(lhs), Arrays.asList(rhs), sFuncTestSignature);
    }

    /**
     * Provides the standard interface for calling the <code>FuncTest</code> MATLAB function with 
     ...
     * @throws MWException An error has occurred during the function call.
     */
    public Object[] FuncTest(int nargout, Object... rhs) throws MWException
    {
        Object[] lhs = new Object[nargout];
        fMCR.invoke(Arrays.asList(lhs), 
                    MWMCR.getRhsCompat(rhs, sFuncTestSignature), 
                    sFuncTestSignature);
        return lhs;
    }
}
